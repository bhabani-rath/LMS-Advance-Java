<%-- 
    ...
    Created on : Nov 16, 2023, 7:02:56 PM
    Author     : CODEHUB_PC
--%>
...
<html>
    ...
    <body>
        <div class="wrapper">
            <h1>Add Librarian</h1>
            <form action="AddLibrarian" class="left" method="post" >
                <table border="0">
                    ...
                    <tr><td class="td1">Mobile No :
                        <td><input type="number" name="mobile"  placeholder="Mobile"></td>

                </table>
                <button type="submit" style="margin-left:80px;margin-top:20px;background:#f6648b">Submit</button>
            </form>
        </div>
    </body>
</html>
