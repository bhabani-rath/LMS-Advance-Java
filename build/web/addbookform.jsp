...
<html>
    <head>
        ...
        <style type="text/css">
            ...
            .wrapper input[type=text],.wrapper input[type=password],.wrapper input[type=number]{
                border :none;
    ...
    <body>
        <div class="wrapper">
            <h1>Add Book Form</h1>
            <form action="AddBook" class="left" method="post" >
                <table border="0">
                    ...
                    <tr> <td class="td1">Name :
                        <td><input type="text" name="name" placeholder="Name"></td>
                    </tr>


                    <tr> <td class="td1">Author :
                        <td><input type="text" name="author" placeholder="Author"></td>
                    </tr>

                    <tr> <td class="td1">Publisher :
                        <td><input type="text" name="publisher" placeholder="Publisher"></td>
                    </tr>

                    <tr> <td class="td1">Quantity :
                        <td><input type="number" name="quantity" placeholder="Quantity"></td>
                    </tr>

                </table>
                <button type="submit" style="margin-left:80px;margin-top:20px;background:#f6648b">Save Book</button>
            </form>
        </div>
    </body>
</html>